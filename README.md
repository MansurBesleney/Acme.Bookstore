...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p be3050cc-cddb-4f28-842a-8af6656daef4
```

> `be3050cc-cddb-4f28-842a-8af6656daef4` is the password of the certificate, you can change it to any password you want.
